...
trait OpenJFX extends JavaModule {
  ...
  val javaFXModuleNames = Seq("base", "controls", "fxml", "graphics", "media", "swing", "web")

  // Extra OpenFX libraries
  // Note that the module name and the library  name are not the same
  val controlsFXModule = "org.controlsfx.controls"

  // TODO: make this a list based on javaFXModuleNames?
  val BASE       = s"org.openjfx:javafx-base:$javaFXVersion"
  val CONTROLS   = s"org.openjfx:javafx-controls:$javaFXVersion"
  val FXML       = s"org.openjfx:javafx-fxml:$javaFXVersion"
  val GRAPHICS   = s"org.openjfx:javafx-graphics:$javaFXVersion"
  val MEDIA      = s"org.openjfx:javafx-media:$javaFXVersion"
  val SWING      = s"org.openjfx:javafx-swing:$javaFXVersion"
  val WEB        = s"org.openjfx:javafx-web:$javaFXVersion"
  val CONTROLSFX = s"org.controlsfx:controlsfx:$controlsFXVersion"
